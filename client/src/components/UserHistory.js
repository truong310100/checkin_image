  ...
  const fetchUserHistory = async () => {
    try {
      ...
      if (response.success) {
        ...
        setError(response.message || 'Không thể tải lịch sử điểm danh');
      }
    } catch (err) {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-blue-100 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600">Đang tải lịch sử điểm danh...</p>
        </div>
      </div>
    );
  }
            ...
            {attendances.length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 mb-6">
                  Người dùng này chưa thực hiện điểm danh lần nào
                </p>
                <button
              ...
              <div>
                <h2 className="text-xl font-semibold text-gray-800 mb-6">
                  Chi tiết điểm danh ({attendances.length} ngày)
                </h2>
