      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="text-center mb-16">
          <h1 className="text-5xl font-bold text-gray-800 mb-4">
            Hệ thống Checkin bằng khuôn mặt
          </h1>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 text-center hover:shadow-xl transition-shadow duration-300">
            <div className="text-6xl mb-6">⏰</div>
            <h3 className="text-2xl font-semibold text-gray-800 mb-4">Checkin</h3>
            <p className="text-gray-600 mb-6">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 text-center hover:shadow-xl transition-shadow duration-300">
            <div className="text-6xl mb-6">📊</div>
            <h3 className="text-2xl font-semibold text-gray-800 mb-4">Lịch sử Checkin</h3>
            <p className="text-gray-600 mb-6">
              Xem lại lịch sử Checkin của tất cả nhân viên trong hệ thống
            </p>
            <Link 
              to="/history" 
